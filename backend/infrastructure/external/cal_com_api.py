...
class CalComAPIClient:
    ...
    async def validate_api_key(self, api_key: str) -> bool:
        ...
        try:
            response = await self.client.get("/me", params={"apiKey": api_key})
    ...
    async def get_event_types(self, api_key: str) -> List[Dict[str, Any]]:
        ...
        try:
            response = await self.client.get("/event-types", params={"apiKey": api_key})
    ...
    async def create_booking(
        ...
        try:
            response = await self.client.post(
                "/bookings", params={"apiKey": api_key}, json=payload
            )
    ...
    async def delete_booking(
        self, api_key: str, booking_uid: str, reason: str = "User cancellation"
    ) -> bool:
